  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(prefixIcon: prefix, suffixIcon: suffix, border: InputBorder.none, hintText: hint, hintStyle: TextStyle(color: Colors.grey, fontSize: 15)),
      ),
    );
  }
}
