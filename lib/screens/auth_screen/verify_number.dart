    ...
    return CupertinoPageScaffold(
      ...
      child: _status != Status.Error
          ? Column(
              ...
              children: [
                Center(
                  child: Text("OTP Verification", style: TextStyle(color: Color(0xFF08C187).withOpacity(0.7), fontSize: 30)),
                ),
          ...
          : Column(
              ...
              children: [
                ...
                CupertinoButton(child: Text("Edit Number"), onPressed: () => Navigator.pop(context)),
                CupertinoButton(
